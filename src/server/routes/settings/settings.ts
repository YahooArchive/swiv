...
router.post('/cluster-connection', (req: SwivRequest, res: Response) => {
...
router.get('/cluster-sources', (req: SwivRequest, res: Response) => {
...
router.post('/attributes', (req: SwivRequest, res: Response) => {
...
router.post('/preview', (req: SwivRequest, res: Response) => {
